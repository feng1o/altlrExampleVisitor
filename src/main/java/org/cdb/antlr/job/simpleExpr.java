...
import org.cdb.antlr.parser.EvalVisitor;
import org.cdb.antlr.parser.*;
...
public class simpleExpr {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (args.length > 0) {
            ...
            System.out.println("last: " + node.get("sql").toString());
            System.out.println("last: " + node.get("sql").asText());
